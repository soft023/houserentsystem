...
<body id="page-top">
  ...
  <div class="card-body w3-text-blue">
    ...
    <h5 class="card-subtitle  text-muted">Email Address</h5>
   @if (session('status'))
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-sm-12 col-md-12 col-lg-12">
                <input class="form-control text-center" style=" font-size:13pt;" name="email" type="email" aria-describedby="textHelp" value="{{old('email')}}" placeholder="Enter your email" required autofocus>
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-12">
                  <button type="submit" class="btn btn-success btn-block" style="font-size : 18px;" name="submit">Submit</button>
                  <br><br>
                  <br><br>
                  <br><br>
