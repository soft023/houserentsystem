...
<body id="page-top">
  ...
  <div class="card-body w3-text-blue">
    <h4 class="card-title">Super Admin Login</h4>
    </div>
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-sm-12 col-md-12 col-lg-12">
                <input class="form-control text-center" style=" font-size:13pt;" name="username" type="text" aria-describedby="textHelp"  placeholder="Enter your username" required autofocus>
